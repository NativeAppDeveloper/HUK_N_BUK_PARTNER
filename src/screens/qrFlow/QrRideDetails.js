...
import RatingModal from '../../component/modal/RatingModal';
  ...
  export default function QrRideDetails() {
      ...
      <View style={{flex: 1, justifyContent: 'flex-end'}}>
        ...
        <View
          ...
          <View
            ...
            <Text20 fontFamily={fonts.semibold} text={rideComplete?'Heading to East Coast Hill':'Ride Details'} />
           ...
           {rideComplete&& <View
                ...
                <Text14 fontFamily={fonts.bold} mt={1} text={'11 : 55'} />
                <Text14 fontFamily={fonts.bold} mt={1} text={'AM'} />
              </View>}
          </View>
