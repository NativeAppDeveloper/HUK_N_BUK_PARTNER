...
const AssignVechicleInformation = () => {
  const dropDownData = [
    {label: 'Car', value: 'Car'},
        ...
        <KeyboardAwareScrollView
          ...
          <View>
            <View
              ...
              <View
                ...
                <View
                  ...
                  <XMarkIcon color={colors.secondry} />
                </View>
              </View>
            ...
            {prefrence==2&&  <View
                ...
                <Text12 text={'Total Base Price:'} fontFamily={fonts.regular} />
              ...
              <View
                style={{marginTop: moderateScale(20), left: moderateScale(20)}}>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{height: 22, width: 22}}>
                      <Image
                        style={[CommonStyle.img]}
                        source={
                          prefrence == 1 ? images.unCheck : images.checkboxcheck
                        }
                      />
                    </View>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{height: 22, width: 22}}>
                      <Image
                        style={[CommonStyle.img]}
                        source={
                          prefrence == 2 ? images.unCheck : images.checkboxcheck
                        }
                      />
                    </View>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{height: 22, width: 22}}>
                      <Image
                        style={[CommonStyle.img]}
                        source={
                          prefrence == 3 ? images.unCheck : images.checkboxcheck
                        }
                      />
                    </View>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{height: 22, width: 22}}>
                      <Image
                        style={[CommonStyle.img]}
                        source={
                          prefrence == 4 ? images.unCheck : images.checkboxcheck
                        }
                      />
                    </View>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{height: 22, width: 22}}>
                      <Image
                        style={[CommonStyle.img]}
                        source={
                          prefrence == 5 ? images.unCheck : images.checkboxcheck
                        }
                      />
                    </View>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{height: 22, width: 22}}>
                      <Image
                        style={[CommonStyle.img]}
                        source={
                          prefrence == 6 ? images.unCheck : images.checkboxcheck
                        }
                      />
                    </View>
...
export default AssignVechicleInformation;
