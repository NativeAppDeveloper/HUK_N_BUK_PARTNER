            ...
            <ScrollView>
              <View
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text14
                      color={paramData?colors.red:colors.orange}
                      lineHeight={0}
                      mt={moderateScale(1)}
                      text={paramData?'• Rejected' : ' • Pending '}
                      //   textAlign={'center'}
                    />
                  </TouchableOpacity>
                </View>
                  ...
                  <View
                    style={{
                      ...
                      marginLeft:10
                        ...
                        <Text12 fontFamily={fonts.semibold} text={'  2 Seats'}/>
             ...
             {[1,1].map((ele,ind)=>{
              ...
              <View
                ...
                <Text18 color={colors.theme} text={'Bidding Details'} />
