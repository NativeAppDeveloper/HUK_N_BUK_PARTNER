            ...
            <ScrollView>
              ...
              </View>
              {
                ...
                <View
                  ...
                  <View>
                    <Text12 color={colors.secondary} text={'UP16-BV-0000'} />
              ...
              <View style={{left: moderateScale(20), top: moderateScale(18)}}>
                <Text18 color={colors.theme} mt={1} text={'Bidding Details'} />
              </View>
              <View
                style={{
                  paddingHorizontal: scale(10),
                    ...
                    (data, ind) => {
                      return (
                        <TouchableOpacity
                          ...
                          <Text12 text={data} color={colors.gray} mt={1} />
                        </TouchableOpacity>
                      );
                    },
                  )}
              ...
              <View
                ...
                <Text14 color={colors.theme} text={'Price Breakup'} />
                ...
                <View
                  ...
                  <Text12 color={colors.placeholderColor} text={'Toll Tax'} />
                  <Text12 color={colors.placeholderColor} text={'1,520'} />
                </View>
                <View
                  style={{
                    flexDirection: 'row',
                  ...
                  <Text12 color={colors.placeholderColor} text={'State Tax'} />
                  <Text12 color={colors.placeholderColor} text={'1,250'} />
                </View>
                <View
                  style={{
                    flexDirection: 'row',
                  ...
                  />
                  <Text12 color={colors.placeholderColor} text={'500'} />
                </View>
                ...
                <View
                  ...
                  <Text12 color={colors.placeholderColor} text={'Parking'} />
                  <Text12 color={colors.placeholderColor} text={'Excluded'} />
                </View>
                ...
                <View
                  ...
                  <Text12
                    color={colors.placeholderColor}
                    text={'Extra Km Charge (Per km)'}
                  />
                  <Text12 color={colors.placeholderColor} text={'20'} />
                </View>
                <View
                  style={{
                    flexDirection: 'row',
                  ...
                  <Text12 color={colors.theme} text={'Estimated Total Fare'} />
                  <Text12 color={colors.theme} text={'7,426'} />
                </View>
              </View>
            </ScrollView>
            <View
